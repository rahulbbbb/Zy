      ...
      <div className={style.aboutPageContainer}>
        <div className={style.topContainer}>
          ...
          <div className={style.topTextSection}>
            ...
            <p>FlexFitness is a fitness hub for anyone who wants to know their bodies inside out and how to work with them. The gym boasts cardio and weights stations, swimming pools, valet parking, squash courts, physiotherapists, spinning studios and a massage center. The gym also has its own fitness academy where it offers courses in fitness management, personal training and group exercise instruction.</p>
            <Link to={"/AboutUs"}>
