...
function handleNewUser(){
  ...
  return (
    <div className={style.loginContainer}>
        ...
        <button type="submit" onClick={handleLoginSubmit} className={style.loginBtn}>Login</button>
        <p>New user ?<button onClick={handleNewUser} className={style.registerbtn}>Register here</button></p>
        </form>
    </div>
  )
}
